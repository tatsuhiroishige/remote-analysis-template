...
// Add to existing PDF
c2->Print(pic_file.c_str());  // Appends page to PDF
```
...
c1->Print((pic_file + "(").c_str());  // Open with "("
...
// Close PDF
c1->Print((pic_file + ")").c_str());  // Close with ")"
```
